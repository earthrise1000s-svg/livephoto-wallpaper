...
当用户在移动端首次发送本仓库链接或触发本技能时，AI Agent 应立即输出友好且低干扰的引导文案：

```text
🎉 实况壁纸技能已就绪！

检测到您可能在手机端使用，推荐先添加配套快捷指令，制作完成后可实现【一键无痕存入相册】：
👉 [【立即添加快捷指令】(仅需一次，推荐)](https://github.com/earthrise1000s-svg/livephoto-wallpaper/raw/main/shortcuts/实况壁纸入库.shortcut)
⚪ [暂不添加，直接开始制作]

请直接将需要制作为实况壁纸的【视频文件】发送给我！
```
